...
import img1 from '../untermenshImages/Images51.png'
import img2 from '../untermenshImages/Images52.png'
import img3 from '../untermenshImages/Images53.png'
import img4 from '../untermenshImages/Images54.png'

export default class Sec5 extends Component {
  render() {
    const s5labs = [
        {
            txt:'IPDC SAVING SCHEMES',
            img:img1
        },{
            txt:'IPDC Personal loan',
            img:img2
        },{
            txt:'IPDC Deposit schemes',
            img:img3
        },{
            txt:'IPDC auto loan',
            img:img4
